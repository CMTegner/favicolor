...
test('should return accept a string', function(t) {
    ...
    t.equals(icon.href, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAB' +
        'CAYAAAAfFcSJAAAABHNCSVQICAgIfAhkiAAAAAlwSFlzAAALEwAACxMBAJqcGAAAABBJRE' +
        'FUCB0BBQD6/wD/AAD/BQAB/yStDWMAAAAASUVORK5CYII=');
    t.end();
});
...
test('should return accept an array', function(t) {
    ...
    t.equals(icon.href, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAB' +
        'CAYAAAAfFcSJAAAABHNCSVQICAgIfAhkiAAAAAlwSFlzAAALEwAACxMBAJqcGAAAABBJRE' +
        'FUCB0BBQD6/wAA/wD/BAEB/ymuTOcAAAAASUVORK5CYII=');
    t.end();
});
...
test('should return accept separate RGB numbers', function(t) {
    ...
    t.equals(icon.href, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAB' +
        'CAYAAAAfFcSJAAAABHNCSVQICAgIfAhkiAAAAAlwSFlzAAALEwAACxMBAJqcGAAAABBJRE' +
        'FUCB0BBQD6/wAAAP//AwIB/8DNK/sAAAAASUVORK5CYII=');
    t.end();
});
